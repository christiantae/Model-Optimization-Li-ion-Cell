...
tic % Monitor time taken to run theode (tic - toc)
...
save('OPT_Params_T23_GA_train_error', 'err_val')
save('OPT_Params_T23_GA.mat','SOC_pulse_range','R0_val_T23','R1_val_T23','C1_val_T23')
